...
const AdModal: React.FC<{ onAdComplete: () => void }> = ({ onAdComplete }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
            <Helmet>
                <meta name="google-adsense-account" content="ca-pub-5750827820025211" />
                <meta name="google-site-verification" content="IPyRRhgxWhjZzmgkPLHZwZ6wc3RIx4L8AB0fNHwYPzE" />
                <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5750827820025211" crossOrigin="anonymous"></script>
            </Helmet>
